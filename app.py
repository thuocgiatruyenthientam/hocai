...
app = Flask(__name__)
# SECURITY: do not hardcode secrets or credentials in source. Use environment variables or a secrets manager.
app.config["SECRET_KEY"] = os.getenv("SECRET_KEY", "replace_with_random_secret")
app.config["ADMIN_PASSWORD"] = os.getenv("ADMIN_PASSWORD", "REPLACE_ME_CHANGE_PASSWORD")
