...
export const metadata: Metadata = {
  ...
  description:
    "Kết nối với Thuốc Nam Thiên Tâm để đặt lịch tư vấn các bài thuốc dân tộc Chăm hỗ trợ sỏi thận, suy thận, viêm cầu thận và đau khớp qua hotline, email hoặc phòng khám.",
  alternates: {
    canonical: absoluteUrl("/lien-he"),
  },
  openGraph: {
    title: "Liên hệ Thuốc Nam Thiên Tâm",
    description:
      "Đặt lịch tư vấn bài thuốc dân tộc Chăm kết hợp y học hiện đại với đội ngũ lương y và bác sĩ cộng tác của Thuốc Nam Thiên Tâm.",
...
const contactChannels = [
  ...
  {
    label: "Phòng khám Thuốc Nam Thiên Tâm",
  ...
  return (
    <section className="mx-auto max-w-3xl space-y-10">
      ...
      <header className="space-y-4 text-center">
        ...
        <h1 className="text-4xl font-semibold text-slate-900">Kết nối với chuyên gia Thuốc Nam Thiên Tâm</h1>
      ...
      <form className="space-y-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm" aria-label="Gửi yêu cầu tư vấn">
        ...
        <p className="text-center text-xs text-slate-500">
          Bằng việc gửi biểu mẫu, bạn đồng ý để Thuốc Nam Thiên Tâm liên hệ qua điện thoại/email trong giờ hành chính.
        </p>
      </form>
    </section>
  );
